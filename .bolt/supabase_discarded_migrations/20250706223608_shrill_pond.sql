...
SELECT 'Sale Confirmation',
       ...
       true
WHERE NOT EXISTS (
  SELECT 1 FROM email_templates WHERE type = 'sale_confirmation'
);
...
SELECT 'Payment Confirmation',
       ...
       true
WHERE NOT EXISTS (
  SELECT 1 FROM email_templates WHERE type = 'payment_confirmation'
);
...
SELECT 'Weekly Summary',
       ...
       true
WHERE NOT EXISTS (
  SELECT 1 FROM email_templates WHERE type = 'weekly_summary'
);
...
SELECT 'Test Email',
       ...
       true
WHERE NOT EXISTS (
  SELECT 1 FROM email_templates WHERE type = 'test'
);
