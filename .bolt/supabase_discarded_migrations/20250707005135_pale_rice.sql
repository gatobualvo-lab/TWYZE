/*
  ...
  2. Security
    ...
    - Add policies with existence checks to prevent duplicates
...
-- Create policies for profiles (with checks to avoid duplicates)
DO $$
BEGIN
  IF NOT EXISTS (
...
-- Create policies for sales (with checks to avoid duplicates)
DO $$
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
...
-- Create policies for suppliers (with checks to avoid duplicates)
DO $$
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
...
-- Create policies for other tables using the same pattern
-- For ad_expenses
DO $$
BEGIN
  IF NOT EXISTS (
...
-- Create unique constraints for dropdown tables
DO $$
BEGIN
  IF NOT EXISTS (
...
BEGIN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'inventory_items' AND policyname = 'Users can view their own inventory_items'
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'inventory_items' AND policyname = 'Users can insert their own inventory_items'
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'stock_transactions' AND policyname = 'Users can view their own stock_transactions'
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'stock_transactions' AND policyname = 'Users can insert their own stock_transactions'
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'payment_submissions' AND policyname = 'Users can view their own payment_submissions'
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'payment_submissions' AND policyname = 'Users can insert their own payment_submissions'
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'user_settings' AND policyname = 'Users can view their own user_settings'
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'user_settings' AND policyname = 'Users can insert their own user_settings'
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'user_settings' AND policyname = 'Users can update their own user_settings'
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'audit_log' AND policyname = 'Users can view their own audit_log'
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'audit_log' AND policyname = 'Users can insert their own audit_log'
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'email_logs' AND policyname = 'Users can view their own email logs'
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'email_logs' AND policyname = 'Admins can view all email logs'
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'email_templates' AND policyname = 'Users can view active email templates'
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'email_templates' AND policyname = 'Admins can manage email templates'
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'user_products' AND policyname = 'Users can view their own user_products'
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'user_products' AND policyname = 'Users can insert their own user_products'
  ) THEN
    CREATE POLICY "Users can insert their own user_products"
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'user_products' AND policyname = 'Users can update their own user_products'
  ) THEN
    CREATE POLICY "Users can update their own user_products"
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'user_products' AND policyname = 'Users can delete their own user_products'
  ) THEN
